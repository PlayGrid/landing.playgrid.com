...
<!-- Slider -->
<section id="home" class="section_slider">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="content_title">
                            ...
                            <ul class="list-unstyled ">
                                <li>
                                    <img src="<?php bloginfo('template_directory');?>/img/slider/1.png" alt="Playgrid-Statistics">
                                </li>
                            </ul>
                        </div>
                        </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <section class="row_experience">
                        <ul class="services">
                            ...
                            <li class="col-xs-12 col-sm-4 col-md-3 col-lg-3 last">
                                <a href="#">
                                    <div class="service">
                                        <div class="service_img row_service">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <a href="https://www.playgrid.com/register/" class="btn btn-success btn-lg btn-custom">Start Free Today <i class="fa fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
